<template>
  <div>
    ...
    <div v-if="!$page.props.auth.user" class="flex flex-row gap-4 pb-6">
      <text-input v-model="nickname" class="w-1/2" :placeholder="'Type your GitHub nickname...'"/>
    ...
    <div v-if="repositoriesForJsonFile.length">
      <div class="flex flex-row gap-6 pb-6">
        ...
        <a v-if="fileExists" href="/repositories/download" class="btn-indigo flex flex-row gap-2">
